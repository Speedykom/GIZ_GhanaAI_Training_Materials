...
Let's dive into a classic classification problem: **predicting passenger survival on the Titanic**.
...
### Visualizing Decision Trees: Titanic and Iris
...
- **Nodes**: Decision points (e.g., "sex_male <= 0.5")
- **Edges**: Branches (True/False)
- **Leaves**: Final predictions
- **Color**: Darker blue = more "Survived" predictions, darker orange = more "Did Not Survive"

**Key insights from this tree:**
1. **Gender is the most important feature** (first split)
2. **Fare and class** are also important
3. The tree is **interpretable**—you can explain each decision!
...
**Next Module: [Notebook 3: Ensemble Methods - The Power of Many](file:///home/siseng_ai/Documents/Ubuntu_2404/Speedykom/Ghana_AI/TrainingMaterials/intro_ML3.qmd)**
